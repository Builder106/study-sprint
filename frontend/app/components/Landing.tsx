...
const FEATURES: ReadonlyArray<{
...
}> = [
  {
    ...
    body: "Stopwatch or Pomodoro, with phase labels and ambient focus sounds. Every session is tagged to a goal and a subject, validated on the server, and folded straight into your streak and your garden — so the time you log is the time that counts.",
    span: "wide",
    pot: "sapling",
  },
  {
  ...
  },
  {
    ...
    body: "Where the hours went, by subject. Which hours of the day you actually focus in. Your current streak against your longest one. It is one Postgres call — analytics_summary — rendered with Recharts.",
    span: "wide",
    pot: "seedling",
  },
  {
    title: "A leaderboard you can opt into",
    body: "Streaks and hours, compared across everyone who chose to make their profile public. Your page lives at /u/your-username, or nowhere at all.",
    span: "wide",
    pot: "bloom",
  },
  {
    title: "The whole garden",
    body: "Every plant you have grown, kept — and longer streaks unlock species you have not seen yet.",
    span: "wide",
    pot: "cluster",
  },
  {
      ...
      <main className="flex-1">
        ...
        <section className="mx-auto grid w-full max-w-6xl items-center gap-12 px-[var(--page-gutter)] pt-[var(--section-gap-tight)] pb-[var(--section-gap)] lg:grid-cols-[7fr_5fr] lg:gap-20">
          <div>
            ...
            >
              StudySprint counts the minutes you were going to spend anyway and gives
              them somewhere to go. Start a timer, tag it to a goal, and watch the
              total turn into a plant that will not grow unless you do the work.
            </p>
            <div

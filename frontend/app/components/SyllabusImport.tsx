          ...
          ? (
            <form onSubmit={onParse} className='flex-1 overflow-y-auto p-8 space-y-6'>
              <p className='text-sm text-zinc-600 dark:text-zinc-400 font-light'>
                Paste your syllabus or upload the PDF. An AI assistant will suggest study goals with
                estimated hours and deadlines. You'll review before anything is saved.
              </p>
                  ...
                  <div className='flex flex-wrap items-center gap-4'>
                    <label className='flex items-center gap-2 text-[10px] font-bold text-zinc-500 uppercase tracking-widest'>
                      ...
                      <input
                        ...
                        onChange={(e) => updateField(i, 'target_hours', Number(e.target.value))}
                    ...
                    <label className='flex items-center gap-2 text-[10px] font-bold text-zinc-500 uppercase tracking-widest'>
                      ...
                      <input
                        type='date'
                        value={g.target_date ?? ''}
                        onChange={(e) => updateField(i, 'target_date', e.target.value || null)}

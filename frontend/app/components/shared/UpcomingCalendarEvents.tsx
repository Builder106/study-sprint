...
import { CalendarClock, CheckCheck, Download, ExternalLink, Plus, X } from 'lucide-react';
  ...
  return (
    <section className='mb-12 border border-zinc-200 dark:border-zinc-800 rounded-xl p-6'>
      ...
      <p className='text-[11px] text-zinc-500 dark:text-zinc-600 mb-5 font-light'>
        Click <span className='font-medium'>Import</span>{' '}
        on an event to log it as a study session. Imports are a one-time snapshot — later edits in
        Google Calendar won't sync back.
      </p>

...
const VARIANTS: Record<PotVariant, () => React.ReactElement> = {
  seedling: () => (
    <>
      <line x1="32" y1="34" x2="32" y2="26" stroke="#87a635" strokeWidth="2" strokeLinecap="round" />
      <path d="M32 28 Q26 25 25 19 Q31 21 32 28" fill="#ccff00" />
    </>
  ),
  unfurl: () => (
    <>
      <line x1="32" y1="34" x2="32" y2="22" stroke="#87a635" strokeWidth="2" strokeLinecap="round" />
  ...
  twin: () => (
    <>
      <line x1="25" y1="34" x2="25" y2="24" stroke="#87a635" strokeWidth="2" strokeLinecap="round" />
      <path d="M25 27 Q19 24 18 18 Q24 20 25 27" fill="#ccff00" />
      <line x1="39" y1="34" x2="39" y2="27" stroke="#87a635" strokeWidth="2" strokeLinecap="round" />
      <path d="M39 29 Q45 27 46 22 Q40 23 39 29" fill="#b3e600" />
    </>
  ),
  sapling: () => (
    <>
      <line x1="32" y1="34" x2="32" y2="14" stroke="#87a635" strokeWidth="2.5" strokeLinecap="round" />
  ...
  bloom: () => (
    <>
      <line x1="32" y1="34" x2="32" y2="20" stroke="#87a635" strokeWidth="2" strokeLinecap="round" />
  ...
  cluster: () => (
    <>
      <line x1="22" y1="34" x2="22" y2="24" stroke="#87a635" strokeWidth="1.5" strokeLinecap="round" />
      <circle cx="22" cy="20" r="5" fill="#ccff00" />
      <circle cx="19" cy="18" r="1.6" fill="#fff" />
      <line x1="32" y1="34" x2="32" y2="18" stroke="#87a635" strokeWidth="1.5" strokeLinecap="round" />
      <circle cx="32" cy="13" r="6" fill="#b3e600" />
      <circle cx="29" cy="10" r="1.8" fill="#fff" />
      <line x1="42" y1="34" x2="42" y2="26" stroke="#87a635" strokeWidth="1.5" strokeLinecap="round" />
  ...
  roots: () => (
    <>
      <line x1="26" y1="34" x2="26" y2="26" stroke="#87a635" strokeWidth="1.8" strokeLinecap="round" />
      <path d="M26 28 Q19 26 18 20 Q24 22 26 28" fill="#ccff00" />
      <line x1="38" y1="34" x2="38" y2="24" stroke="#87a635" strokeWidth="1.8" strokeLinecap="round" />
